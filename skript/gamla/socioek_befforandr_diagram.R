...
px_df <- px_df %>% 
  mutate(förändringar = case_when (förändringar == "födelseöverskott" ~ "Födelsenetto",
...
# sortera om grupperna
beffor$grupp <- factor(beffor$grupp, levels = c("Utrikes flyttnetto män", "Utrikes flyttnetto kvinnor",
